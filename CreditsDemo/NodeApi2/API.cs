...
namespace NodeApi
{
  public partial class API {
    public interface ISync {
      ...
      string WaitForSmartTransaction(byte[] smart_public);
    ...
    public interface Iface : ISync {
      ...
      string End_WaitForSmartTransaction(IAsyncResult asyncResult);
      #endif
      #if SILVERLIGHT
    ...
    public class Client : IDisposable, Iface {
      ...
      public string End_WaitForSmartTransaction(IAsyncResult asyncResult)
      {
        oprot_.Transport.EndFlush(asyncResult);
      ...
      public string WaitForSmartTransaction(byte[] smart_public)
      {
        #if !SILVERLIGHT
      ...
      public string recv_WaitForSmartTransaction()
      {
        TMessage msg = iprot_.ReadMessageBegin();
        if (msg.Type == TMessageType.Exception) {
          TApplicationException x = TApplicationException.Read(iprot_);
